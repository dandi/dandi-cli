...
def test_nwbfile_to_dict(simple1_nwb):
    ...
    dict2 = {
        ...
        'datasets': {'file_create_date': {'data': '<HDF5 dataset "file_create_date": shape (1,), type "|O">'},
                     'identifier': {'data': 'identifier1'},
                     'session_description': {'data': 'session_description1'},
                     'session_start_time': {'data': '2017-04-15T12:00:00+00:00'},
                     'timestamps_reference_time': {'data': '2017-04-15T12:00:00+00:00'}},
        'groups': {'general': {'datasets': {'experiment_description': {'data': 'experiment_description1'},
                                            'experimenter': {'data': '<HDF5 dataset "experimenter": shape (1,), type "|O">'},
                                            'institution': {'data': 'institution1'},
                                            'keywords': {'data': '<HDF5 dataset "keywords": shape (2,), type "|O">'},
                                            'lab': {'data': 'lab1'},
                                            'related_publications': {'data': '<HDF5 dataset "related_publications": shape (1,), type "|O">'},
                                            'session_id': {'data': 'session_id1'}}},
                   'stimulus': {'groups': {}}}}

    dict2['attributes'].update(
        object_id=dict1['attributes']['object_id'],  # fix object_id, which is generated randomly
        nwb_version=dict1['attributes']['nwb_version']  # allow version to update
    )
